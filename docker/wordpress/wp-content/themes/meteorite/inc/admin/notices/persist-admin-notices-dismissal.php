...
if ( ! class_exists( 'PAnD' ) ) {
	...
	class PAnD {
		...
		public static function load_script() {
			...
			wp_enqueue_script(
				'meteorite-dismissible-notices',
				get_template_directory_uri() . '/inc/admin/js/dismissible-notice.js',
				array( 'jquery', 'common' ),
				false,
				true
			);

			wp_enqueue_style( 'meteorite-dismissible-notices-styles', get_template_directory_uri() . '/inc/admin/css/dismissible-notice.css' );
